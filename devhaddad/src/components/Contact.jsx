    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 xl:gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-400 p-4 border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
              ...
              <a
                ...
                className="block break-all text-sm sm:text-lg font-bold text-white hover:underline"
              >
          ...
          >
            {/* Campo de E-mail (Obrigatório para o Formspree saber quem enviou) */}
            <div className="flex flex-col">
              ...
              <input
                type="email"
                name="_replyto" // Usar _replyto ajuda o Gmail a saber para quem responder
                required
            ...
            <div className="flex flex-col">
              ...
              <textarea
                name="message" // Nome padrão que ele identifica bem
                required
